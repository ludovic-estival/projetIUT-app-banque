...
public class ComptesManagement {
	...
	public CompteCourant creerCompte() {
		...
		if (compte != null) {
			...
			AlertUtilities.showAlert(this.primaryStage, "Erreur de creation de compte", null, "Le solde du compte doit être supérieur ou égal à 50.",
					AlertType.WARNING);
		}
		}
		return compte;
	...
	public void faireSimulation() {
		EmpruntManagement em = new EmpruntManagement(this.primaryStage, this.dbs);
