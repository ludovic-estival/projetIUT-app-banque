...
public class CompteEditorPaneController implements Initializable {
	...
	public CompteCourant displayDialog(Client client, CompteCourant cpte, EditionMode mode) {
		...
		case MODIFICATION:
			...
			this.lblMessage.setText("Modification du compte n° : " + this.compteEdite.idNumCompte);
		...
		case SUPPRESSION:
			...
			this.txtSolde.setDisable(true);
			this.lblMessage.setText("Clôture du compte n° : " + this.compteEdite.idNumCompte);
			this.lblSolde.setText("Solde");
			this.btnOk.setText("Clôturer");
			this.btnCancel.setText("Annuler");
			break;
		}
