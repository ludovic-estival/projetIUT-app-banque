...
L'application est codée avec JavaFX. Plus de détails https://github.com/ludovic-estival/projetIUT-app-banque/blob/main/documentation/doc_technique/v3/doc_tech.v3.adoc[ici].

== 5 - Résultats

Dans le cahier des charges l'application a 3 version différentes. Nous avons atteint la version 3, avec quelques fonctionnalités non implémentées par manque de temps.
